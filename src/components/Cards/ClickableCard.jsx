...
const ClickableCard = ({children, className='', href, onClick, asButton=false}) => {
  let Component;

  if(asButton) Component = motion.button;
  else if(href) Component = motion.a;
  else Component = motion.div;
  ...
  if(asButton) sharedProps.type = 'submit';
  else if(href){
